...
import { RegisteredResponseModule, ExecutionContext, ExecutionEvents, ExecutionStore } from './types';
...
export declare class RequestFactory {
   ...
   */
  processRequest(request: ArcEditorRequest): Promise<ArcEditorRequest|null>;
   ...
   */
  processResponse(request: ArcEditorRequest, executed: TransportRequest, response: Response|ErrorResponse): Promise<void>;
